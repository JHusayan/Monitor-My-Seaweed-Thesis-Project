...
{
 $chart_data .= "{ xtimetempp:'".$row["xtimetempp"]."', ydatatempp:".$row["ydatatempp"]."}, ";
}
while($row = mysqli_fetch_array($result2))
{
 $chart_data2 .= "{ xtimephh:'".$row["xtimephh"]."', ydataphh:".$row["ydataphh"]."}, ";
}
while($row = mysqli_fetch_array($result3))
{
 $chart_data3 .= "{ xtimeturbidity:'".$row["xtimeturbidity"]."', ydataturbidity:".$row["ydataturbidity"]."}, ";
}
while($row = mysqli_fetch_array($result4))
{
 $chart_data4 .= "{ xtimesalinity:'".$row["xtimesalinity"]."', ydatasalinity:".$row["ydatasalinity"]."}, ";
}
while($row = mysqli_fetch_array($result5))
{
 $chart_data5 .= "{ xtimewater:'".$row["xtimewater"]."', ydatawater:".$row["ydatawater"]."}, ";
}
